...
## Progress and Challenges:
Work on the GitHub has improved after the initial issues noted in checkpoint #1. There was some mismatch in the correct repository location and then delay in uploading, but we can now upload and update without having to send pull requests to commit changes to the checkpoint #2. There was addional data clenaing done to prep the data better for use in tablue as well. 
...
* Drafted update for the checkpoint 2 readme file.

### Nick:
* Worked to clean the supporting FHFA dataset.
* Set up the new Git repository.
* coordinated the updates and use of the correct repository for checkpoint 2.
